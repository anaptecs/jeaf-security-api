 ...
 * @see SystemException
 */
public final class AuthorizationException extends SystemException {
  /**
   ...
   */
  public AuthorizationException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public AuthorizationException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public AuthorizationException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * @param pCause Throwable object that caused this exception. The parameter may be null.
   */
  public AuthorizationException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
   ...
   * null.
   */
  public AuthorizationException( ErrorCode pErrorCode, String pTechnicalDetails, Throwable pCause,
