 ...
 * @see SystemException
 */
public final class IdentityProviderSystemException extends SystemException {
  /**
   ...
   */
  public IdentityProviderSystemException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public IdentityProviderSystemException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public IdentityProviderSystemException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * @param pCause Throwable object that caused this exception. The parameter may be null.
   */
  public IdentityProviderSystemException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
   ...
   * null.
   */
  public IdentityProviderSystemException( ErrorCode pErrorCode, String pTechnicalDetails, Throwable pCause,
